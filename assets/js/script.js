...
let homeLink = document.querySelector('nav ul li a[href="#home"]');
...
var options = {
    strings: ['Java Full-Stack web developer','Front-End web developer', 'Back-End web developer', 'Web designer'],
    loop: true,
    typeSpeed: 70,
    backSpeed: 10
};
